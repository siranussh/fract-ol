...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/04 19:55:45 by sihakoby          #+#    #+#             */
/*   Updated: 2025/07/04 19:57:47 by sihakoby         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	fract->k_real = fract->min_real + (double)x * (fract->max_real
			- fract->min_real) / WIDTH;
	fract->k_imaginary = fract->max_imaginary + (double)y
